...
var file_material_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x32, 0x8d, 0x05, 0x0a, 0x0f,
	...
	0x44, 0x1a, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x2d, 0x0a, 0x10,
	0x46, 0x69, 0x6e, 0x64, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x42, 0x79, 0x55, 0x73, 0x65, 0x72,
	0x12, 0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x49, 0x44, 0x1a, 0x0d, 0x2e, 0x70,
	0x62, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x04, 0x5a, 0x02, 0x2e,
...
var file_material_proto_depIdxs = []int32{
	...
	12, // 13: pb.MaterialService.FindAllItem:input_type -> pb.ItemNoParams
	8,  // 14: pb.MaterialService.EditItem:input_type -> pb.Item
	10, // 15: pb.MaterialService.RemoveItem:input_type -> pb.ItemID
	13, // 16: pb.MaterialService.PlaceOrder:input_type -> pb.Order
	12, // 17: pb.MaterialService.OrderHistory:input_type -> pb.ItemNoParams
	10, // 18: pb.MaterialService.FindOrder:input_type -> pb.ItemID
	10, // 19: pb.MaterialService.FindOrdersByUser:input_type -> pb.ItemID
	4,  // 20: pb.MaterialService.AddMaterial:output_type -> pb.MaterialResponse
	3,  // 21: pb.MaterialService.FindMaterialByID:output_type -> pb.Material
	6,  // 22: pb.MaterialService.FindAllMaterial:output_type -> pb.MaterialList
	3,  // 23: pb.MaterialService.EditMaterial:output_type -> pb.Material
	4,  // 24: pb.MaterialService.RemoveMaterial:output_type -> pb.MaterialResponse
	9,  // 25: pb.MaterialService.AddItem:output_type -> pb.ItemResponse
	8,  // 26: pb.MaterialService.FindItemByID:output_type -> pb.Item
	11, // 27: pb.MaterialService.FindAllItem:output_type -> pb.ItemList
	8,  // 28: pb.MaterialService.EditItem:output_type -> pb.Item
	9,  // 29: pb.MaterialService.RemoveItem:output_type -> pb.ItemResponse
	15, // 30: pb.MaterialService.PlaceOrder:output_type -> pb.OrderResponse
	14, // 31: pb.MaterialService.OrderHistory:output_type -> pb.OrderList
	13, // 32: pb.MaterialService.FindOrder:output_type -> pb.Order
	14, // 33: pb.MaterialService.FindOrdersByUser:output_type -> pb.OrderList
